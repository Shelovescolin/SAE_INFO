<?php
    ...
    if(empty($_SESSION['nom']) OR empty($_SESSION['prenom']) OR empty($_SESSION['mail']) OR empty($_SESSION['password']))
    {
        ...
        echo "<a href='http://localhost:3000/SAE_INFO/index.html'><button>Accueil</button></a></br>";
    ...
    else
    {
        ...
        echo "<a href='http://localhost:3000/SAE_INFO/change_infos.html'><button>Modifier les infos de votre compte</button></a>";
        echo "<a href='http://localhost:3000/SAE_INFO/delete_account.html'><button>Supprimer votre compte</button></a>";    
    }
